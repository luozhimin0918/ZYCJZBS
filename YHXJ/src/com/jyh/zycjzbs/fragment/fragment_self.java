package com.jyh.zycjzbs.fragment;
...
import com.jyh.zycjzbs.Login_One;
import com.jyh.zycjzbs.R;
import com.jyh.zycjzbs.TiaoKuanActivity;
import com.jyh.zycjzbs.UserActivity;
...
import com.jyh.zycjzbs.common.utils.imageutils.ImageDownLoader;
import com.jyh.zycjzbs.common.utils.imageutils.ImageDownLoader.AsyncImageLoaderListener;
import com.jyh.zycjzbs.common.utils.LoginInfoUtils;
import com.jyh.zycjzbs.common.utils.SPUtils;
import com.jyh.zycjzbs.common.utils.ToastView;
import com.jyh.zycjzbs.common.utils.dialogutils.BaseAnimatorSet;
import com.jyh.zycjzbs.common.utils.dialogutils.BounceTopEnter;
import com.jyh.zycjzbs.common.utils.dialogutils.NormalDialog;
import com.jyh.zycjzbs.common.my_interface.OnBtnClickL;
import com.jyh.zycjzbs.common.utils.dialogutils.SlideBottomExit;
import com.jyh.zycjzbs.common.utils.NetworkCenter;
import com.jyh.zycjzbs.common.utils.VersionManager;

import java.lang.ref.WeakReference;

public class fragment_self extends Fragment implements OnClickListener {
    private LinearLayout self_ll_clear, self_ll_about, self_ll_out, self_ll_tj, self_user,self_ll_tiaoku;
    ...
    private void Init() {
        ...
        self_ll_tiaoku.setOnClickListener(this);
    }
    ...
    private void InitFind(View view) {
        ...
        self_ll_tiaoku= (LinearLayout) view.findViewById(R.id.self_ll_tiaoku);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            ...
            case R.id.self_ll_out:
                ...
                break;
            case R.id.self_ll_tiaoku:
                intent = new Intent(getActivity(), TiaoKuanActivity.class);
                startActivity(intent);
                break;
            case R.id.self_user:
